...
\begin{doublespace}
	...
	\nohyphenation
    Dedicated to my family and my best friend \texttt{Neeraj K. Gaud} !
\end{doublespace}
\vfill
\vfill
% r.9 introduction
...
This sample book discusses the course \texttt{Module Theory} of
\texttt{pure mathematics} being taught to \doccls{post-graduate} students
in \doccls{University of Delhi.}
%%
