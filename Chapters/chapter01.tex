...
\begin{definition}[Ring Homomorphism]
	...
	f : R \rightarrow S
	\end{equation*}
	is said to be a ring homomorphism or ring linear map if for every $a \ ,\ b \in R$ following properties holds\marginnote{if $R$ = $S$ then we call ring homo as ring endomorphism. For instance , let $f$ be ring homo from $R$ to $R$ . we say $f$ is endomorphism of $R$ and denoted by $End \ R$}
	\begin{description}
...
\begin{description}
	...
	from hypothesis, there exist a map
\end{description}
\end{proof}
